...
welcome-step-1 = "록맨 에그제 어드밴스드 컬렉션" 유무 확인
welcome-step-1-description = 록맨 에그제 어드밴스드 컬렉션을 Steam에 설치해야 합니다.
...
welcome-step-1-roms = ROM 추가
welcome-step-1-description-roms = 게임 ROM을 ROMs 폴더에 넣어 주세요.
