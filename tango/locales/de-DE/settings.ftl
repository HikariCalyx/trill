...
settings-input-socd-resolution = SOCD-Auflösung
    .natural = Natürlich (keine Auflösung)
    .neutral = Neutral (SOCD-N)
    .last-input-priority = Letzte Eingabepriorität (SOCD-L)
...
settings-quick-initialize = Schnelle Initialisierung
